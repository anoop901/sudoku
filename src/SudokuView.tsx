...
export default function SudokuView(props: { sudoku: Sudoku }) {
  ...
  const possibleValuesAtSelectedLocation = props.sudoku.possibleValuesAtLocation(
    selectedLocation
  );
  return (
    <>
                    ...
                    <tr>
                      {Array.from({ length: 3 }, (_, colInBox) => {
                        ...
                        return (
                          ...
                          >
                            {props.sudoku.valueAtLocation(location) ?? ""}
                          </td>
                        );
                      })}
                    </tr>
      ...
      <p>
        The currently selected cell could be any of: [
        {possibleValuesAtSelectedLocation.join(", ")}]
      </p>
    </>
  );
}
